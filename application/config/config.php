...
|
*/
$root = (PHP_SAPI === 'cli' || defined('STDIN')) ? 'http://localhost/' : ((isset($_SERVER['HTTPS']) ? "https://" : "http://") . $_SERVER['HTTP_HOST'] . str_replace(basename($_SERVER['SCRIPT_NAME']), '', $_SERVER['SCRIPT_NAME']));
...
|
*/
$config['encryption_key'] = 'wipsto_2026_kap_secret_key_change_me';
